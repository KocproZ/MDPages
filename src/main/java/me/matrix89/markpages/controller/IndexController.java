...
public class IndexController {
    ...
    public String index(Model m, Principal principal) {
        if (principal != null) {
            ...
            m.addAttribute("pages", pageRepository.findAllByVisibility(PageModel.Visibility.PUBLIC, new Sort(Sort.Direction.ASC, "name")));
        }
    ...
    public @ResponseBody
    List<PageModel> test() {
        return pageRepository.findAllByMaintainer_Id(1);
    }
