...
public class MultipartFileSender {
    ...
    public static MultipartFileSender data(FileModel file) {
        return new MultipartFileSender().file(file);
    }

    private MultipartFileSender file(FileModel file) {
        this.file = file;
        return this;
    }
    ...
    public void serveResource() throws IOException {
        ...
        Date lastModifiedDate = file.getLastEdited();
        long lastModified = LocalDateTime.ofInstant(lastModifiedDate.toInstant(), ZoneId.of(ZoneOffset.systemDefault().getId())).toEpochSecond(ZoneOffset.UTC);
        ...
        // Prepare streams.
        try (InputStream input = new BufferedInputStream(new ByteArrayInputStream(file.getData()));
